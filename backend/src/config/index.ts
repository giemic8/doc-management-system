...
export const config = {
  ...
  storageEncryptionKey: process.env.STORAGE_ENCRYPTION_KEY || 'change_this_storage_encryption_key_in_prod',
  storageEncryptionEnabled: process.env.STORAGE_ENCRYPTION_ENABLED === 'true',
